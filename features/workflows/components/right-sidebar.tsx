  ...
  if (!node) {
    return (
      <Section title="Editor">
        <p className="p-3 text-sm text-muted-foreground">No mode selected</p>
      </Section>
    );
  }
...
const definations = Object.values(nodeRegistry);
...
const RightSidebar = ({ workflowId }: { workflowId: string }) => {
